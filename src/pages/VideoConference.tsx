...
export default function VideoConference() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-display font-bold text-foreground">Video Conference</h1>
        <p className="text-sm text-muted-foreground">Meet with your accounts team</p>
      </div>
      ...
      {!inMeeting ? (
        <Card className="border-0 shadow-sm">
          <CardContent className="p-8 text-center space-y-4">
            ...
            <h2 className="text-lg font-display font-semibold">Start or Join a Meeting</h2>
            <p className="text-sm text-muted-foreground max-w-md mx-auto">Connect with the accounts team to review financial data. Your dashboard can be shared during the call.</p>
        ...
        <>
            ...
            <div className="bg-foreground/95 aspect-video relative flex items-center justify-center">
              ...
              {sharing && (
                <div className="absolute top-3 left-3 bg-destructive text-destructive-foreground text-xs px-2 py-1 rounded-md flex items-center gap-1">
                  <Monitor className="h-3 w-3" /> Sharing Dashboard
                </div>
              )}
            </div>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Card className="border-0 shadow-sm">
              <CardHeader className="pb-2">
                <CardTitle className="text-base font-display flex items-center gap-2">
                  <MessageSquare className="h-4 w-4" /> AI Meeting Notes
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="bg-accent rounded-lg p-3 text-xs text-muted-foreground space-y-1">
                  <p>• Meeting started — 4 participants joined</p>
                  <p>• Dashboard shared for Q4 review</p>
                  <p>• Awaiting discussion points...</p>
                </div>
              </CardContent>
            </Card>
          </div>
