  ...
  return (
    <div className="space-y-4">
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        {/* Top Overdue */}
        <Card className="border-0 shadow-sm">
          <CardHeader className="pb-2"><CardTitle className="text-sm font-display">Top Overdue Customers</CardTitle></CardHeader>
              ...
              {overdueReceivables.map((r) => (
                <div key={r.customer} className="flex items-center justify-between px-5 py-3">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{r.invoiceCount} invoices · {r.daysPastDue}d overdue</p>
                  </div>
